...
const COMMANDS: readonly CommandSpec[] = [
  ...
  {
    name: "sync",
    usage: ["wl sync [--repo owner/name] [--force] [--dry-run]", "wl sync --push [--repo owner/name] [--dry-run]", "wl sync --pull [--repo owner/name] [--force] [--dry-run]", "wl sync --persist [--force] [--dry-run]", "wl sync --reconcile [--repo owner/name] [--dry-run]"],
    ...
    details: [
      ...
      "  --force              With --pull, overwrite local changes; with --persist, overwrite issue mismatches.",
      "",
      "AUTH",
